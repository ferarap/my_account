...
describe GroceryListsController do
  ...
  describe "GET new" do
    it "assigns a new grocery_list as @grocery_list" do
      ...
      assigns(:grocery_list).should be_a_new(GroceryList)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created grocery_list as @grocery_list" do
        post :create, {:grocery_list => valid_attributes}, valid_session
        assigns(:grocery_list).should be_a(GroceryList)
        assigns(:grocery_list).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved grocery_list as @grocery_list" do
        ...
        GroceryList.any_instance.stub(:save).and_return(false)
        post :create, {:grocery_list => { "name" => "invalid value" }}, valid_session
        assigns(:grocery_list).should be_a_new(GroceryList)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested grocery_list" do
        grocery_list = GroceryList.create! valid_attributes
        # Assuming there are no other grocery_lists in the database, this
        # specifies that the GroceryList created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        GroceryList.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => grocery_list.to_param, :grocery_list => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the grocery_list as @grocery_list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        GroceryList.any_instance.stub(:save).and_return(false)
        put :update, {:id => grocery_list.to_param, :grocery_list => { "name" => "invalid value" }}, valid_session
        assigns(:grocery_list).should eq(grocery_list)
      end
